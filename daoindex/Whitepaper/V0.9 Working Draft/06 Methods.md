...
We reviewed [number of works] articles, from DAO-related academic and grey literature to identify questions (or criteria) relevant to assessing DAOs, including issues faced by DAOs in practice, and to identify principles for guidance on how DAOs should be operated and governed. 
...
Assessments were conducted between 2022 and 2023.
...
Initilaly, the questionnaire was devloped by generating a set of questions. 

Generally, questions were generated from drawing insights from academic and/or grey literature (from any discipline and industry vertical for DAOs), that better informed us of design choices for DAOs. Similarly for the principles. 
...
Through this process, we reduced the number of items and principles as we piloted prior versions of the DIAI, ultimately leading to the current version, V0.9. 
## Instrument (or Survey) Analysis

%% May want to hold off on this section until we have more data.%%
...
2. conducted Principal Component Analysis (PCA) to determine whether to remove an item[^1][^2] %%can remove%%
3. conducted Confirmatory Factor Analysis (CFA) to determine construct validity[^3] %%Is this the right factor analysis to do?%%
	1. %%may not be appropriate because we have a very small dataset (only 11 assessments). So maybe save this one for V1.0 and doing more assessments%%
4. %%?determined areas of improvement for the questionnaire?%%
...
[^3]: [Factor Analysis: a means for theory and instrument development in support of construct validity](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7883798/)
